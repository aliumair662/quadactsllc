            ...
            <div class="app-page-title">
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        ...
                        <div>Spoilage/Loss
                            <div class="page-title-subheading">The Inventory Spoilage / lost while processing in work-in
                                process.
                            </div>
                    ...
                    <div class="page-title-actions">
                        <a href="{{ route('newSpoilageLoss') }}">
                            <button type="button" data-toggle="tooltip" title="" data-placement="bottom"
                                class="btn-shadow mr-3 btn btn-dark" data-original-title="Add Spoilage / lost">
                                                ...
                                                <td class="text-center">
                                                    <div class="mb-2 mr-2 btn-group">
                                                        ...
                                                        <div tabindex="-1" role="menu" aria-hidden="true"
                                                            ...
                                                            <a href="{{ route('editSpoilageLoss', $list->id) }}"><button
                                                                    type="button" tabindex="0"
                                                                    class="dropdown-item">Edit</button></a>
                                                            <a href="#"
                                                                onclick="deleteRecord('{{ route('deleteSpoilageLoss', $list->id) }}');"><button
                                                                    type="button" tabindex="0"
