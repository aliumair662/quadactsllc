    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
                ...
                <div class="page-title-wrapper">
                    ...
                    <div class="page-title-actions">
                        <a href="{{ route('spoilageOrLoss') }}">
                            <button type="button" data-toggle="tooltip" title="" data-placement="bottom" class="btn-shadow mr-3 btn btn-dark" data-original-title="Spoilage/Loss List">
            ...
            <div class="main-card mb-3 card">
                <form class="Q-form" action="{{(isset($record)) ? route('updateSpoilageLoss') : route('saveSpoilageloss')}}" method="post">
                    @csrf
                        ...
                        <div class="form-row">
                            <div class="col-md-2">
                                <div class="position-relative form-group">
                                    ...
                                    <input name="invoice_number" id="invoice_number" placeholder="" type="text" value="{{(isset($record)) ? $record->voucher_number : Config::get('constants.SPOILAGE_INVENTORY').$invoice_number}}" class="form-control" readonly>
                                </div>
                            </div>
