    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
                    ...
                    <div class="page-title-actions">
                        <a href="{{ route('newEmployeePayment') }}">
                            <button type="button" data-toggle="tooltip" title="" data-placement="bottom"
                                class="btn-shadow mr-3 btn btn-dark" data-original-title="Add New Employee Payment">
            ...
            <div class="text-right">
                <a href="{{ route('employeePayPagePdf', ['from_date' => isset($from_date) ? $from_date : 'none', 'to_date' => isset($to_date) ? $to_date : 'none', 'employee_name' => isset($employee_name) ? $employee_name : 'none', 'invoice_number' => isset($invoice_number) ? $invoice_number : 'none']) }}"
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="form-group col-2 ml-2">
                                ...
                                <input type="text" name="employee_name" class="form-control"
                                    value="{{ isset($employee_name) ? $employee_name : '' }}" placeholder="name">
                            </div>
                            <div class="form-group col-2 ml-2">
                                                ...
                                                <td class="text-center">
                                                    <div class="mb-2 mr-2 btn-group">
                                                        ...
                                                        <div tabindex="-1" role="menu" aria-hidden="true"
                                                            ...
                                                            <a href="{{ route('editEmployeePayment', $list->id) }}"><button
                                                                    type="button" tabindex="0"
                                                                    class="dropdown-item">Edit</button></a>
                                                            <a href="{{ route('deleteEmployeePayment', $list->id) }}"><button
                                                                    type="button" tabindex="0"
