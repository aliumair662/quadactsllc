    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
            ...
            <div class="text-right">
                <a href="{{ route('saleReturnPagePdf', ['from_date' => isset($from_date) ? $from_date : 'none', 'to_date' => isset($to_date) ? $to_date : 'none', 'customer_id' => isset($customer_id) ? $customer_id : 'none', 'invoice_number' => isset($invoice_number) ? $invoice_number : 'none']) }}"
                                                ...
                                                <td class="text-center">
                                                    <div class="mb-2 mr-2 btn-group">
                                                        ...
                                                        <div tabindex="-1" role="menu" aria-hidden="true"
                                                            ...
                                                            <a href="{{ route('editSaleReturn', $list->id) }}"><button
                                                                    type="button" tabindex="0"
                                                                    class="dropdown-item">Edit</button></a>
                                                            <a href="#"
                                                                onclick="deleteRecord('{{ route('deleteSaleReturn', $list->id) }}');"><button
                                                                    type="button" tabindex="0"
                                                                    class="dropdown-item">Delete</button> </a><a
                                                                href="{{ route('saleReturnRecordPDF', $list->id) }}"><button
                                                                    type="button" tabindex="0"
