                    ...
                    <div class="page-title-actions">
                        <a href="{{ route('newFinishedGoods') }}">
                            <button type="button" data-toggle="tooltip" title="" data-placement="bottom"
                                class="btn-shadow mr-3 btn btn-dark" data-original-title="Add Finish Goods Inventory">
                                                ...
                                                <td class="text-center">
                                                    <div class="mb-2 mr-2 btn-group">
                                                        ...
                                                        <div tabindex="-1" role="menu" aria-hidden="true"
                                                            ...
                                                            <a href="{{ route('editFinishedGoods', $list->id) }}"><button
                                                                    type="button" tabindex="0"
                                                                    class="dropdown-item">Edit</button></a>
                                                            <a href="#"
                                                                onclick="deleteRecord('{{ route('deleteFinishedGoods', $list->id) }}');"><button
                                                                    type="button" tabindex="0"
