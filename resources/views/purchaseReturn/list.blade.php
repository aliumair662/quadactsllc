    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
                    ...
                    <div class="page-title-actions">
                        <a href="{{ route('newPurchaseReturn') }}">
                            <button type="button" data-toggle="tooltip" title="" data-placement="bottom"
                                ...
                                data-original-title="Add New Purchase Return Invoice">
            ...
            <div class="text-right">
                <a href="{{ route('purchaseReturnPagePdf', ['from_date' => isset($from_date) ? $from_date : 'none', 'to_date' => isset($to_date) ? $to_date : 'none', 'vendor_id' => isset($vendor_id) ? $vendor_id : 'none', 'invoice_number' => isset($invoice_number) ? $invoice_number : 'none']) }}"
                                                ...
                                                <td class="text-center">
                                                    <div class="mb-2 mr-2 btn-group">
                                                        ...
                                                        <div tabindex="-1" role="menu" aria-hidden="true"
                                                            ...
                                                            <a href="{{ route('editPurchaseReturn', $list->id) }}"><button
                                                                    type="button" tabindex="0"
                                                                    class="dropdown-item">Edit</button></a>
                                                            <a href="#"
                                                                onclick="deleteRecord('{{ route('deletePurchaseReturn', $list->id) }}');"><button
                                                                    type="button" tabindex="0"
                                                                    class="dropdown-item">Delete</button></a>
                                                            <a href="{{ route('purchaseReturnPdf', $list->id) }}"><button
                                                                    type="button" tabindex="0"
