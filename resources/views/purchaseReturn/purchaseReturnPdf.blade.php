        ...
        <table style="width: 100%;" collspacing="0" class="">
            <tr>
                ...
                <td class="align-middle">
                    <div class="ml-4">
                        <p class="mb-1">Invoice #: {{ $purchaseReturn->invoice_number }}</p>
                        <p class="mb-1">Invoice Date:
                            {{ \Carbon\Carbon::parse($purchaseReturn->invoice_date)->format('d-m-Y') }}</p>
                    </div>
                </td>
            </tr>
        </table>
    </div>
    <p class="text-right"><b>Purchase Return Invoice </b></p>
