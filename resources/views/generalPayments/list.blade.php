    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
                    ...
                    <div class="page-title-actions">
                        <a href="{{ route('newGeneralPayments') }}">
                            <button type="button" data-toggle="tooltip" title="" data-placement="bottom"
                                class="btn-shadow mr-3 btn btn-dark" data-original-title="Add New General Payment">
            ...
            <div class="text-right">
                <a href="{{ route('generalPayPdf', ['from_date' => isset($from_date) ? $from_date : 'none', 'to_date' => isset($to_date) ? $to_date : 'none', 'invoice_number' => isset($invoice_number) ? $invoice_number : 'none']) }}"
                                                ...
                                                <td class="text-center">
                                                    <div class="mb-2 mr-2 btn-group">
                                                        ...
                                                        <div tabindex="-1" role="menu" aria-hidden="true"
                                                            ...
                                                            <a href="{{ route('editGeneralPayment', $list->id) }}"><button
                                                                    type="button" tabindex="0"
                                                                    class="dropdown-item">Edit</button></a>
                                                            <a href="#"
                                                                onclick="deleteRecord('{{ route('deleteGeneralPayment', $list->id) }}');"><button
                                                                    type="button" tabindex="0"
                                                                    class="dropdown-item">Delete</button></a><a
                                                                href="{{ route('generalpayRecordPdf', $list->id) }}"><button
                                                                    type="button" tabindex="0"
