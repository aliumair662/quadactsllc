        ...
        <div class="app-main__inner">
            ...
            <div class="main-card mb-3 card">
                <form class="Q-form" enctype="multipart/form-data"
                    action="{{ isset($vendor) ? route('updatevendor') : route('savevendor') }}" method="post">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <div class="position-relative form-group">
                                    ...
                                    <input name="email" id="password" placeholder="password placeholder"
                                        type="email" value="{{ isset($vendor) ? $vendor->email : '' }}"
                                        class="form-control">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="position-relative form-group">
                                    ...
                                    <input name="phone" id="phone"
                                        value="{{ isset($vendor) ? $vendor->phone : '' }}" type="text"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="position-relative form-group">
                                    ...
                                    <input name="address" id="address"
                                        value="{{ isset($vendor) ? $vendor->address : '' }}" type="text"
                                        class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        @if (isset($vendor))
                            <div class="col-md-6 mt-4">
                                ...
                                <label class="switch">
                                    <input type="checkbox"
                                        {{ isset($vendor) ? ($vendor->status == 1 ? 'checked' : '') : '' }}
                                        value="1" name="status">
