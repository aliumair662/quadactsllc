    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
                    ...
                    <div class="page-title-actions">
                        <a href="{{ route('vendorpaymentlist') }}">
                            <button type="button" data-toggle="tooltip" title="" data-placement="bottom"
                                class="btn-shadow mr-3 btn btn-dark" data-original-title="Vendor Payments List">
            ...
            <div class="main-card mb-3 card">
                <form class="Q-form"
                    action="{{ isset($vendorpayment) ? route('updatevendorpayment') : route('savevendorpayment') }}"
                    method="post">
                    @csrf
                    <div class="card-body">
                        <h5 class="card-title">
                            {{ isset($vendorpayment) ? 'Edit Vendor Payment' : 'Add Vendor Payment' }}</h5>
                        <div class="form-row">
                            <div class="col-md-2">
                                <div class="position-relative form-group">
                                    <label for="exampleEmail11" class="">Voucher No#</label>
                                    <input name="voucher_number" id="invoice_number" placeholder="" type="text"
                                        value="{{ isset($vendorpayment) ? $vendorpayment->voucher_number : Config::get('constants.VENDOR_PAYMENT_PREFIX') . $voucher_no }}"
                            ...
                            <div class="col-md-2">
                                <div class="position-relative form-group">
                                    ...
                                    <input name="voucher_date" id="invoice_date" placeholder="" type="date"
                                        value="{{ isset($vendorpayment) ? $vendorpayment->received_date : date('Y-m-d') }}"
                                        class="form-control">
                                </div>
                                <input type="hidden" name="id"
                                    value="{{ isset($vendorpayment) ? $vendorpayment->id : '' }}">
                            </div>
                            <div class="col-md-2">
                                <div class="position-relative form-group">
                                        ...
                                        @if (!empty($vendors))
                                            @foreach ($vendors as $vendor)
                                                <option value="{{ $vendor->id }}"
                                                    {{ isset($vendorpayment) ? ($vendorpayment->vendor == $vendor->id ? 'selected' : '') : '' }}>
                                                    {{ $vendor->name }} </option>
                                            @endforeach
                                        @endif
                                    </select>
                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="d-flex align-items-baseline col-md-2">
                                        ...
                                        <input type="radio" class="cash"
                                            name="payment_mode"style="position: relative; top:2px;" value="1"
                                            {{ isset($vendorpayment) ? ($vendorpayment->payment_mode == 1 ? 'checked' : '') : 'checked' }}>
                                    </div>
                                    <div class="d-flex align-items-baseline col-md-2">
                                        <label for="cash" class="mr-2 pb-3"
                                    ...
                                    <div class="d-flex align-items-baseline col-md-2">
                                        ...
                                        <input type="radio" name="payment_mode" class="bank_check_toggle"
                                            ...
                                            {{ isset($vendorpayment) ? ($vendorpayment->payment_mode == 3 ? 'checked' : '') : '' }}>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row" id="show_hide_inps"
                            ...
                            <div class="form-group col-md-5">
                                ...
                                <input type="text" class="form-control bank_name" name="bank_name"
                                    value="{{ isset($vendorpayment) ? $vendorpayment->about_bank : '' }}">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-5">
                                <div class="position-relative form-group">
                                    ...
                                    <input name="amount" id="net_total" placeholder="" type="text"
                                        value="{{ isset($vendorpayment) ? $vendorpayment->amount : '' }}"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-md-12">
                    ...
                    <div class="d-block text-center card-footer">
                        <button type="submit"
                            class="mt-2 btn btn-primary">{{ isset($vendorpayment) ? 'Update' : 'Save' }}</button>
                    </div>
                </form>
            </div>
