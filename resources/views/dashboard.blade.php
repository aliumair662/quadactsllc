            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card mb-3 widget-content bg-asteroid">
                        <div class="widget-content-wrapper text-white">
                            ...
                            <div class="widget-content-right">
                                <div class="widget-numbers text-white"><span>{{ $data['quotation'] }}</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4">
                    <div class="card mb-3 widget-content bg-love-kiss">
                        <div class="widget-content-wrapper text-white">
                            <div class="widget-content-left">
                                <div class="widget-heading">Daily Visits</div>
                                <div class="widget-subheading">Till Now</div>
                            </div>
                            <div class="widget-content-right">
                                <div class="widget-numbers text-white"><span>{{ $data['daily_visits'] }}</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="widget-content-wrapper">
                                    ...
                                    <div class="widget-content-right">
                                        <div class="widget-numbers text-success">
                                            {{ Config::get('constants.DEFAULT_CURRENCY') }}{{ $data['totalCash'] }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="widget-content-wrapper">
                                    <div class="widget-content-left">
                                        <div class="widget-heading"><a
                                                href="{{ route('accountReceivable') }}">Account
                                                Receivable</a></div>
                                        <div class="widget-subheading">Revenue streams</div>
                                    </div>
                                    <div class="widget-content-right">
                                    ...
                                    <tbody>
                                        @if (!empty($customerReceipts))
                                            @foreach ($customerReceipts as $receipt)
                                                <tr>
                                                    <td class="text-center text-muted">{{ $receipt->voucher_number }}
                                                    </td>
                                                    {{-- <td>
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                            ...
                            @foreach ($todo as $list)
                                <div
                                    ...
                                    <div class="widget-content">
                                        <div class="widget-content-outer">
                                            <div class="widget-content-left fsize-1">
                                                <div class="text-muted opacity-6"><b>Title: </b> {{ $list->title }}
                                                </div>
                                                <div class="text-muted opacity-6"><b>Desc:
                                                    </b>{{ $list->description }}
                                                </div>
                                            </div>
                                        </div>
