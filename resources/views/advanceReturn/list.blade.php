    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
                    ...
                    <div class="page-title-actions">
                        <a href="{{ route('newAdvanceReturn') }}">
                            <button type="button" data-toggle="tooltip" title="" data-placement="bottom"
                                class="btn-shadow mr-3 btn btn-dark" data-original-title="Add New Advance Return">
            ...
            <div class="text-right">
                <a href="{{ route('advanceReturnPagePDf', ['from_date' => isset($from_date) ? $from_date : 'none', 'to_date' => isset($to_date) ? $to_date : 'none', 'employee_name' => isset($employee_name) ? $employee_name : 'none', 'invoice_number' => isset($invoice_number) ? $invoice_number : 'none']) }}"
                                                ...
                                                <td class="text-center">
                                                    <div class="mb-2 mr-2 btn-group">
                                                        ...
                                                        <div tabindex="-1" role="menu" aria-hidden="true"
                                                            ...
                                                            <a href="{{ route('deleteAdvanceReturn', $list->id) }}"><button
                                                                    type="button" tabindex="0"
                                                                    class="dropdown-item">Delete</button></a>
                                                            <a href="{{ route('advanceReturnPdf', $list->id) }}"><button
                                                                    type="button" tabindex="0"
